...
| 时间 | 类型 | 目标 | 状态 | 主题 | 日志 |
| --- | --- | --- | --- | --- | --- |
| 2026-09-06 | feature | 移除场景7蝴蝶的翼面纹理，参考亮色蝴蝶图改为以亮黄、微橙为主的程序流动混色自发光材质，同时避免纯发光单色，并提供多套方案供选择。 | archived | butterfly-procedural-flow-emissive-material | [[日志/2026-09-06-场景7蝴蝶改为程序流动混色发光材质.md|2026-09-06｜场景7蝴蝶改为程序流动混色发光材质]] |
...
| 2026-09-05 | feature | 用户指定参考 makemepulse 2019 开场截图及桌面提取副本，新增场景1，原场景1保留并移为场景2。用户补充原站为 https://2019.makemepulse.com/。 | archived | nomadic-opening-scene-insertion | [[日志/2026-09-05-新增Nomadic纸纹开场并顺延场景.md|2026-09-05｜新增Nomadic纸纹开场并顺延场景]] |
...
| 2026-09-04 | feature | - | archived | sun-ray-visibility-transition | [[日志/2026-09-04-为太阳光束增加边缘与时间渐隐.md|为太阳光束增加边缘与时间渐隐]] |
