...
export function organizeViewerPanel(gui) {
  ...
  const order = ['场景选择', '深邃效果', '场景2·花粉星云', '场景3·指尖花火', '场景4·无限花开', '场景5·纸飞机环游', '场景6·蝶翼', '场景7·斑驳光影', '场景8·纵深花廊', '场景9·狮城手记', '梦境背景与迎光', '指针视差', 'HDRI 环境设置', '外框插槽管理', '内框插槽管理', '渲染设置'];
